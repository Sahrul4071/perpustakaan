...
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <h3 class="card-title"><b>Laporan Hari Ini</b> <br> <span class="text-muted fs-6"><?= $dateNow->toLocalizedString('d MMMM Y');?>, 
      Pukul :  <?= $dateNow->toLocalizedString('HH:mm:ss');?></span></h3>
      </div>
      <div class="card-body">
      ...
      <div class="card-body">
        <div class="d-sm-flex d-block align-items-center justify-content-between mb-9">
          <div class="mb-3 mb-sm-0">
            <h5 class="card-title fw-semibold">Laporan 7 hari terakhir</h5>
          </div>
        </div>
        <div id="chart"></div>
      </div>
